...
export const demonstracaoContent: DemonstracaoContent = {
  ...
  banner: {
    ...
    body: "Veja como é simples incluir o Veggiedent® no momento do petisco.",
    ctaLabel: "Quero receber o guia gratuito",
  },
  intro:
    "Os vídeos abaixo mostram o momento de oferecer o petisco, do desembalar à primeira mordida. Vale assistir antes da estreia do seu cão com o Veggiedent®.",
  videos: [
    {
