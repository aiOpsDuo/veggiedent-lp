...
> exibida antes de um vídeo tocar é o primeiro quadro do próprio arquivo (ver
> `../PAINEL.md`, "Vídeo: o que o operador envia, e por que não existe campo
> de miniatura"). Nada aqui é usado pela página.
