...
/**
 * A única imagem opcional das 9 seções, e por quê: o fundo do banner da
...
describe('invariantes do esquema de seção', () => {
  it('percorre as 9 seções e não encontra nenhuma violação', () => {
  ...
  it('toda imagem das 9 seções é obrigatória, e o texto alternativo também', () => {
