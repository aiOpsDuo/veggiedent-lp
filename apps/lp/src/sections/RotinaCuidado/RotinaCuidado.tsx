...
export const RotinaCuidado = connectSection('rotina', RotinaSteps)

function RotinaSteps({ content }: { content: SectionContent<'rotina'> }) {
    ...
    <div ref={containerRef} style={{ background: 'linear-gradient(to bottom, #e8f7f6 0%, #27B6AD 28%, #27B6AD 100%)' }}>
      <SectionShell id="rotina" aria-labelledby="rotina-heading">
        <div className="rotina-header-el">
          <SectionHeading id="rotina-heading">{content.heading}</SectionHeading>
        </div>
        <p className="rotina-header-el mt-4 max-w-[70ch] text-lg text-ink-900/90">{content.intro}</p>
