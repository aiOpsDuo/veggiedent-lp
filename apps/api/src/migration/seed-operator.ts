 ...
 *
 * Sem Supabase, não existe mais um painel de terceiro onde criar a primeira
 * conta de um ambiente novo — antes disso, ninguém entra no painel (a
 * "armadilha" documentada em `docs/MIGRAR-PARA-NOVO-SUPABASE.md`). Este
 * módulo é a lógica pura do comando `npm run seed:operator`
